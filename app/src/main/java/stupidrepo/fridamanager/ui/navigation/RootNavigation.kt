...
import stupidrepo.fridamanager.ui.screens.RootScreen
import stupidrepo.fridamanager.ui.screens.intro.WelcomeScreen
...
internal fun RootAppNavigation(
    ...
    NavHost(
        ...
        startDestination = if (!isSetupComplete) Routes.Welcome.route else Routes.Main.route,
        modifier = modifier
    ) {
        welcomeComposable(
            navController = navHostController,
